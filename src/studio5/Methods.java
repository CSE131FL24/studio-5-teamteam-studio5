...
public class Methods {
	...
	/**
	 * This is the method use to calculate the mean value of an int array
	 * in the method we get the sum first, then use the sum and divide by the length of the array
	 */
